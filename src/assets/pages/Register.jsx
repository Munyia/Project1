    ...
    <div className="relative py-3 sm:max-w-xl sm:mx-auto">
      <div className="relative px-4 py-10 bg-white mx-8 md:mx-0 shadow rounded-3xl sm:p-10">
        <div className="max-w-md mx-auto">
          ...
          <form className="grid grid-cols-1 sm:grid-cols-2 gap-5">
            <div>
              <label htmlFor="fullname" className="font-semibold text-sm text-gray-600 pb-1 block">Full Name</label>
              <input
            ...
            <div>
              <label htmlFor="phonenumber" className="font-semibold text-sm text-gray-600 pb-1 block">Phone Number</label>
              <input
                className="border rounded-lg px-3 py-2 mt-1 mb-5 text-sm w-full focus:border-blue-500 focus:ring-2 focus:ring-blue-500"
                type="number"
                id="phonenumber"
      ...
      <select className="">
        ...
        <option value="canada">Canada</option>
            ...
            <div>
              <label htmlFor="address" className="font-semibold text-sm text-gray-600 pb-1 block">Address</label>
              <input
                className="border rounded-lg px-3 py-2 mt-1 mb-5 text-sm w-full focus:border-blue-500 focus:ring-2 focus:ring-blue-500"
                type="text"
                id="address"
